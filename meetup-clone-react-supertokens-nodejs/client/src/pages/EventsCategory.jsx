...
import { fetchEventByCategory, slugToSentence } from "../utils/util"
...
const EventsCategory = () => {
    ...
    useEffect(() => {
        fetchEventByCategory(category, setEvents)
    }, [category])
  ...
  return (
   <>
      ...
      <div className="home_events" style={{paddingTop: "20px"}}>
              <h1 style={{ fontSize: "30px", marginBottom: "20px" }}>{slugToSentence(category)}</h1>
